...
public abstract class Filter {
	...
	protected boolean filter(boolean acceptNulls, boolean matchAll, VariantFilter.Operator operator, Object object, Object value) {
		if (object == null) return acceptNulls;
